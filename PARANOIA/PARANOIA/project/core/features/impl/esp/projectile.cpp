...
namespace features::esp {
        ...
        for ( const auto& proj : systems::g_collector.projectiles( ) )
        {
            ...
            if ( proj.subtype == systems::collector::projectile_subtype::molotov_fire )
            {
                ...
                if ( cfg.show_name )
                {
                    ...
                    const auto name = std::string(ecrypt("fire") );
    ...
    std::string projectile::get_name( systems::collector::projectile_subtype type ) const
    {
        ...
        switch ( type )
        {
        case st::he_grenade:    return ecrypt("he");
        case st::flashbang:     return ecrypt("flash");
        case st::smoke_grenade: return ecrypt("smoke");
        case st::molotov:       return ecrypt("molotov");
        case st::molotov_fire:  return ecrypt("fire");
        case st::decoy:         return ecrypt("decoy");
        default:                return ecrypt("grenade");
        }
    }
