 ...
 */
 ...
 /* Force disable any export/import logic from FreeType */
#undef DLL_EXPORT
#undef DLL_IMPORT
#undef FT2_BUILD_LIBRARY

/* Explicitly define the attribute as empty to prevent __declspec(dllexport) */
...
#define FT_HAS_SBIX( face ) \
   ...
   *   application to paranoia the bitmap strike with the corresponding
